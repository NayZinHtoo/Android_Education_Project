...
public class WifiDirectBoradcastReceiver extends BroadcastReceiver {

    private WifiP2pManager mManager;
    private WifiP2pManager.Channel mChannel;
    private WifiConnecter activity;
    private  Context context;

    public WifiDirectBoradcastReceiver(WifiP2pManager mManager, WifiP2pManager.Channel mChannel, WifiConnecter activity) {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)){
            ...
            if(networkInfo.isConnected()){
                ...
                activity.textInfo.setText("Device Disconnected");
